...
{
    readonly List<MessageSentEventHandler> _beforeMessageSent = new();
    readonly List<MessageSentEventHandler> _afterMessageSent = new();
    readonly List<MessageHandledEventHandler> _beforeMessageHandled = new();
    readonly List<MessageHandledEventHandler> _afterMessageHandled = new();
